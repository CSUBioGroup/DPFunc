...
from godone.objective import AverageMeter
from godone.evaluation import compute_performance, new_compute_performance_deepgoplus
...
def test_performance_gnn(model, dataloader, test_pid_list, test_go, idx_goid, goid_idx, ont, device, save=False, save_file=None, evaluate=True):
    model.eval()
    ...
    if evaluate:
        ...
        new_fmax, new_aupr, new_t = new_compute_performance_deepgoplus(df,go_file,ont)
