...
def get_whole_pdb_graph(pdb_points, pid_list, map_pid_esm_file, residue_features, thresholds, ont, tag):
    ...
    for pid in tqdm(pid_list):
        ...
        if p_cnt%5000==0:
            save_pkl('/public/home/hpc224701029/walker/function/data_list/PDB/graph_feature/{}_{}_whole_pdb_part{}.pkl'.format(ont, tag, file_idx), pdb_graphs)
            p_cnt = 0
            file_idx += 1
            pdb_graphs = []
    if len(pdb_graphs)>0:
...
def main(data_cnf, thresholds):
    ...
    save_pkl('/public/home/hpc224701029/walker/function/data_list/{}_{}_used_pid_list.pkl'.format(ont, 'test'), used_pid_list)
    ...
    save_pkl('/public/home/hpc224701029/walker/function/data_list/{}_{}_used_pid_list.pkl'.format(ont, 'train'), used_pid_list)
